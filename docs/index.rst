...
The tool is a Tethys application with scripts for automated install and data downloads, several tools
for data visualization through maps and charts, and a REST API for programmatic access to the data.
